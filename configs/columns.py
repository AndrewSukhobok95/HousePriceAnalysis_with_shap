flats_choosed_columns = [
    ...
    'church_count_5000',
    'church_synagogue_km',
    'culture_objects_top_25_no',
    'culture_objects_top_25_raion',
    'detention_facility_km',
    'detention_facility_raion_no',
    'ecology_excellent',
    'ecology_good',
    'ecology_no data',
    'ecology_poor',
...
essential_columns = ["full_sq", "life_sq", "kitch_sq", "num_room", "build_year", "max_floor", "state",
...
drop_columns = ['id','timestamp', 'ID_big_road1', 'ID_big_road2',
                'ID_railroad_station_avto', 'ID_railroad_station_walk',
                'ID_metro', 'ID_bus_terminal', 'ID_railroad_terminal']
